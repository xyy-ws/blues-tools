...
export const BUNDLED_REAL_TRACKS: RealTrack[] = [
  {
    ...
    fileUrl: '/audio/backing/slow-blues-shuffle-c-68.wav',
    fileType: 'audio/wav',
    fileSize: 0,
  },
  {
    ...
    fileUrl: '/audio/backing/medium-chicago-shuffle-a-98.wav',
    fileType: 'audio/wav',
    fileSize: 0,
  },
  {
    ...
    fileUrl: '/audio/backing/texas-blues-straight-e-108.wav',
    fileType: 'audio/wav',
    fileSize: 0,
  },
]
