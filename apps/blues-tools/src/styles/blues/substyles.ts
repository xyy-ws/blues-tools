...
export const BLUES_SUBSTYLE_LIBRARY: BluesSubstyle[] = [
  {
    ...
    commonProgressionBackingIdeas: [
      '单和弦 vamp（如 E5 持续）+ 低音 ostinato',
      'I 和弦为主，偶尔短暂去 bVII 或 IV 再回 I',
      '吉他/贝斯保持固定 riff，鼓组用 tom + 军鼓反复塑形',
    ],
    recommendedBpmRange: '80-110 BPM',
    keyPracticeTips: [
      '先练 2-4 小节循环的稳定度，优先“稳”和“重”',
      '用闷音与开放弦对比做层次，不要过多换和弦',
      '即兴时围绕主音和小三度做微小变化，保持 trance 感',
    ],
    ...
    tags: ['riff', 'drone', 'one-chord', 'rural'],
  },
  {
    id: 'delta-blues',
    nameZh: '三角洲布鲁斯',
    ...
    grooveRhythmTraits: [
      '独奏叙事感强，节奏自由度高',
      '滑棒（slide）与人声呼应常见',
      'shuffle 与直八都能出现，但核心是“说话式”律动',
    ],
    commonProgressionBackingIdeas: [
      '12 小节蓝调基础（I-IV-V）',
      '早期常见 8 小节/变体结构，句尾 turnaround 灵活',
      '开放调弦（Open G/Open D）+ 滑棒营造持续张力',
    ],
    ...
    tags: ['slide', 'acoustic', 'roots', 'traditional'],
  },
  {
    id: 'chicago-blues',
    nameZh: '芝加哥布鲁斯',
    ...
    grooveRhythmTraits: [
      '电声编制（电吉他、口琴、贝斯、鼓）',
      '中速 shuffle 和重 backbeat 常见',
      '乐句更“乐队导向”，强调 call-and-response',
    ],
    commonProgressionBackingIdeas: [
      '经典 12 小节 I-IV-V + 强 turnaround',
      '钢琴/吉他 boogie bass 线与 shuffle 节奏并行',
      '主歌留空间给人声，间奏用短句反复强化 hook',
    ],
    recommendedBpmRange: '90-130 BPM',
    keyPracticeTips: [
      '先锁定 shuffle 八分摇摆比例，再加花',
      '练“留白”：每句后故意空半拍到一拍',
    ...
    tags: ['electric', 'shuffle', 'band', 'urban'],
  },
  {
    id: 'texas-blues',
    nameZh: '德州布鲁斯',
    ...
    grooveRhythmTraits: [
      '更强调吉他音色、动态和单音线条',
      '可从轻 shuffle 到偏直八的强劲推进',
      '常融合 swing、jump 与早期 rock 感',
    ],
    commonProgressionBackingIdeas: [
      '12 小节为核心，但常加入 quick change 和 passing chord',
      '主音 riff + 双音/六度和声填充',
    ...
    tags: ['guitar-led', 'expressive', 'electric', 'modern'],
  },
  {
    id: 'piedmont-blues',
    nameZh: '皮德蒙特布鲁斯',
    ...
    grooveRhythmTraits: [
      '拇指低音 + 手指旋律的 ragtime 式分工',
      '节奏轻快、跳跃，常带舞曲气质',
      '指弹纹理清晰，复音进行比滑棒更常见',
    ],
    commonProgressionBackingIdeas: [
      '12 小节与 8 小节结构都常见',
      '交替低音（alternating bass）+ 上声部分解和弦',
    ...
    tags: ['fingerstyle', 'ragtime', 'acoustic', 'syncopation'],
  },
]
