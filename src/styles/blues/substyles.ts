...
export const BLUES_SUBSTYLE_LIBRARY: BluesSubstyle[] = [
  {
    ...
    representativeSongsArtists: [
      '代表曲目：《Poor Black Mattie》— R.L. Burnside',
      '代表曲目：《All Night Long》— Junior Kimbrough',
      '代表艺人：Cedell Davis / Otha Turner',
    ],
  ...
  },
  {
    ...
    representativeSongsArtists: [
      '代表曲目：《Cross Road Blues》— Robert Johnson',
      '代表曲目：《Death Letter Blues》— Son House',
      '代表艺人：Charley Patton / Skip James',
    ],
    tags: ['滑棒', '原声', '根源', '传统'],
  },
  {
    ...
    representativeSongsArtists: [
      '代表曲目：《Hoochie Coochie Man》— Muddy Waters',
      '代表曲目：《Smokestack Lightnin’》— Howlin’ Wolf',
      '代表艺人：Little Walter / Willie Dixon',
    ],
    tags: ['电声', '摇摆', '乐队', '都市'],
  },
  {
    ...
    representativeSongsArtists: [
      '代表曲目：《Pride and Joy》— Stevie Ray Vaughan',
      '代表曲目：《Hide Away》— Freddie King',
      '代表艺人：T-Bone Walker / Lightnin’ Hopkins',
    ],
    tags: ['吉他主导', '表现力', '电声', '现代'],
  },
  {
    ...
    representativeSongsArtists: [
      '代表曲目：《West Coast Blues》— Blind Blake',
      '代表曲目：《Cincinnati Flow Rag》— Rev. Gary Davis',
      '代表艺人：Mississippi John Hurt / Brownie McGhee',
    ],
    tags: ['指弹', '原声', '拉格泰姆', '切分'],
  },
]
